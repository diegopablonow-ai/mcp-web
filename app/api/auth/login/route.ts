...
// SameSite=Strict cookies are a strong control but verifying Origin
// provides defence-in-depth against same-site subdomain compromise.
// ---------------------------------------------------------------------------
function isTrustedOrigin(req: Request): boolean {
  if (!IS_PROD) return true // skip in dev
...
export async function POST(req: Request) {
  ...
  // 2. Rate limiting — 10 attempts per IP per 15 minutes
